...
The documentation for LIFE-STAGES is managed in two places (relative to the repository root):
...
2. Now you are ready to build the docs as follows:
   ...
   ```
   INFO    -  Your documentation should shortly be available at: https://obophenotype.github.io/developmental-stage-ontologies/ 
   ```
3. Just to double check, you can now navigate to your documentation pages (usually https://obophenotype.github.io/developmental-stage-ontologies/). 
